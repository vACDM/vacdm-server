...
function buttonStyle(style: string | undefined) {
  switch (style) {
    ...
    case 'warning':
      return 'focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 lg:py-2 dark:focus:ring-yellow-900';
    case 'danger':
